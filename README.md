...
Rocky Linux 10 Cloud Images, [refer to the mirrors list](https://mirrors.rockylinux.org/mirrormanager/mirrors/Rocky/10.0/x86_64).

```bash
sudo rm -rf /var/lib/libvirt/images/Rocky-10-GenericCloud-Base.latest.x86_64.qcow2
sudo curl -o /var/lib/libvirt/images/Rocky-10-GenericCloud-Base.latest.x86_64.qcow2 -fsSL https://mirror.eu.ossplanet.net/rockylinux/10/images/x86_64/Rocky-10-GenericCloud-Base.latest.x86_64.qcow2
virsh pool-refresh default
```

Ubuntu 24.04 LTS (Noble), [refer to the current list](https://cloud-images.ubuntu.com/noble/current/).

```bash
sudo rm -rf /var/lib/libvirt/images/noble-server-cloudimg-amd64.img
sudo curl -o /var/lib/libvirt/images/noble-server-cloudimg-amd64.img -fSL https://cloud-images.ubuntu.com/noble/current/noble-server-cloudimg-amd64.img
virsh pool-refresh default
```

If the command `virsh pool-refresh default` fails, you may need to setup the default storage pool first:
...
You can find an example in the [examples directory](examples/) of how to use this module.
